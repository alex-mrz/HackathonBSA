          ...
          <header className="sticky top-0 z-30 backdrop-blur bg-white/60 border-b border-slate-200/70">
            <nav className="mx-auto max-w-6xl px-4 h-14 flex items-center justify-between">
              <Link href="/" className="flex items-center gap-2 font-semibold">
                <span className="inline-flex h-7 w-7 items-center justify-center rounded-lg bg-blue-600 text-white text-sm">
                  ✓
                </span>
              ...
              <div className="hidden sm:flex items-center gap-6 text-sm">
                ...
                <Link href="/candidats" className="hover:text-blue-700">
                  Votes
                </Link>
                <a href="#securite" className="hover:text-blue-700">
                  Sécurité
                </a>
            ...
            <div className="mx-auto max-w-6xl px-4 py-10 grid gap-8 sm:grid-cols-4">
              <div className="sm:col-span-2">
                <div className="flex items-center gap-2 font-semibold">
                  <span className="inline-flex h-7 w-7 items-center justify-center rounded-lg bg-blue-500 text-white text-sm">
                    ✓
                  </span>
                  <span>VoteSecure</span>
                </div>
                <p className="mt-3 text-sm text-slate-400">
                  Participez à la démocratie numérique avec notre plateforme de
                  vote sécurisée. Votre voix compte — nous la protégeons.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-slate-300">
                  <li>
                    <Link href="/candidats" className="hover:underline">
                      Comment voter
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#resultats" className="hover:underline">
                      Résultats
                    </a>
                  </li>
                  <li>
